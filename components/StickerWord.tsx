  ...
  return (
    ...
    >
      ...
      {/* Text layer — always present, switches color based on which
         layer it sits over (yellow at rest, green on hover). The
         leading mark is Pineapple Design Studio's actual brand logo
         (a yellow line-drawn pineapple); it sits next to the wordmark
         to ground the chip in the real brand. */}
      <span
        className="relative inline-flex items-center gap-[0.32em]"
        style={{
